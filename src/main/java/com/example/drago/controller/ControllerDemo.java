...
import com.example.drago.model.dto.UserRequest;
...
public class ControllerDemo {
	...
	@PostMapping("/user")
	public ResponseEntity<?> getUser(@RequestBody UserRequest userRequest) throws Exception {
		try {
		    return ResponseEntity.ok().body(usersService.getUser(userRequest.user()));
